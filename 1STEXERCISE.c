...
→ PROBLEM NO . 1.1
  ramesh basic salary is input , his dearness allownance (da) is 40% , house rent allowance (hra) is 20% of basic salary calculate gross salaray (gs)
→ PROBLEM NO . 1.2
  to change distance from kilometers (km) into metres (m) , feet (ft) , inches (in) and centimeters (cm)
→ PROBLEM NO . 1.3
